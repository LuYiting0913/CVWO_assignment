...
class GradesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post grades_url, params: { grade: { code: @grade.code, score: @grade.score, student_id: @grade.student_id } }
    end
  ...
  test "should update grade" do
    patch grade_url(@grade), params: { grade: { code: @grade.code, score: @grade.score, student_id: @grade.student_id } }
